...
function render(params) {
    ...
    params.forEach((book, index) => {
        ...
        // cloneTemp.querySelector(".image").src='./';
...
document.querySelector(".saves").addEventListener("click", () => {
...
elForm.addEventListener("submit", (evt) => {
    ...
    let searchQueryText = books.filter(book => String(book.title).match(searchQuery) || String(book.author).match(searchQuery))
